...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line.me/ti/p/tF0Bkk0wDD",
    "lang":"JP",
    "comment":"Owner : line.me/ti/p/tF0Bkk0wDD",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
				...
				if msg.from_ in admin:
					md = ""
				        if wait["Protectguest"] == True: md+="􀔃􀆑lock􏿿  Block Join\n"
...
#-----------------------------------------------
            ...
            elif msg.text in ["Masuk","Jarvis","My waifu sini"]:
				if msg.from_ in admin:
...
#.acceptGroupInvitationByTicket(msg.to,Ticket)
				...
				if msg.from_ in admin:
							...
							kc.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["Out","out","Bye sayang"]:
				if msg.from_ in admin:
					if msg.toType == 2:
						ginfo = cl.getGroup(msg.to)
						try:
...
#-----------------------------------------------
				...
				kk.sendText(msg.to,"wew 魛渷魛厰Har Har魪靠")
